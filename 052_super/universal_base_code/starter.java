...
class starter {
	...
	Apprentice two = new Apprentice("USC", 7);
	Apprentice three = new Apprentice("Triangle", "UCLA", 8);
	Apprentice four = new Apprentice("Will", 34, "Saxophone", "Rice University", 14);
